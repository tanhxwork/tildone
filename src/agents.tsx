...
// Official brand marks (source: simple-icons, CC0), single-path so `currentColor`
// tints them with each agent's accent. Nominative use — the mark names which real
// product touched the task; it never stands in for the vendor as an author.
...
// The OpenAI blossom — Codex is an OpenAI product.
